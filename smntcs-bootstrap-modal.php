...
function smntcs_bootstrap_modal_define_shortcode() {
    ...
    <p>
        <button type="button" class="btn btn-primary" data-toggle="modal"
                data-target="#myModal"><?php echo get_option( 'smntcs_bootstrap_modal_button' ); ?></button>
    </p>
	<?php
}
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"
                        id="myModalLabel"><?php echo get_option( 'smntcs_bootstrap_modal_title' ); ?></h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default"
                            data-dismiss="modal"><?php _e( 'Close', 'smntcs-bootstrap-modal' ); ?></button>
                </div>
            </div>
        </div>
    </div>
